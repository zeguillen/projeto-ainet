...
Route::middleware('auth')->patch('/pilotos/{piloto}/certificado', 'UserController@certificadoPiloto')->name('ver.certificado');
Route::middleware('auth')->patch('/pilotos/{piloto}/licenca', 'UserController@licencaPiloto')->name('ver.licenca');
